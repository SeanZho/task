...
const Stats = () => {
  ...
  return (
    <div className='products-list-container'>
      {topSell?.products?.length && <ProductList title={'Top 5 Sells'} products={topSell.products} count={topSell.count} />}
      {topUnique?.products?.length &&<ProductList title={'Top 5 Unique'} products={topUnique.products} count={topUnique.count}  />}
      {pastDays?.products?.length && <ProductList title={'Top 5 In Past Days'} products={pastDays.products} count={pastDays.count} />}
    </div>
  );
};
